...
namespace ITventory.Infrastructure.Identity.RegistrationService
{
    public class RegisterUserHandler: ICommandHandler<RegisterUser>
    {
        ...
        private UserManagerDbContext _userManagerDbContext;

        public RegisterUserHandler(IEmployeeRepository employeeRepository, UserManager<UserIdentity> userManager, UserManagerDbContext userManagerDbContext)
        {
