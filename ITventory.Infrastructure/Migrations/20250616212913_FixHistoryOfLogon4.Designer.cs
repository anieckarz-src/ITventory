...
namespace ITventory.Infrastructure.Migrations
{
    ...
    [Migration("20250616212913_FixHistoryOfLogon4")]
    partial class FixHistoryOfLogon4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ITventory.Domain.Logon", b =>
                {
                    ...
                    b.HasOne("Hardware", null)
                        .WithMany("_historyOfLogons")
                        .HasForeignKey("HardwareId1");
